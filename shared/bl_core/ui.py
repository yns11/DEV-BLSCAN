...
# Réexport : la fonction vit dans `repository`, pour rester accessible aux
# tâches Lakeflow qui n'ont pas Streamlit installé.
libelle_statut = repository.libelle_statut
